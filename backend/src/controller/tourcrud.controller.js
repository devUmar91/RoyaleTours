...
export const UploadItems = async (req, res, next) => {
  console.log("UploadItems function called"); // Logging entry point
  ...
  try {
    for (const file of files) {
      ...
      console.log("Uploading file:", localPath); // Log each file path
    ...
    console.log("Upload successful:", cloudinaryUrls); // Log successful uploads
