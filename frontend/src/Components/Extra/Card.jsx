...
const Card = ({ tour }) => {
  return (
    <div className="block relative mt-10 w-[90%] h-[500px]  pb-1  shadow-lg hover:cursor-pointer overflow-hidden rounded-lg bg-gray-800 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.7),0_10px_20px_-2px_rgba(0,0,0,0.6)] hover:scale-105 transition transform ease-in">
      <div key={tour.id}>
        ...
        <div className="content p-4">
          <div className="pt-2 h-16">
            <h5 className="mb-2 text-lg font-bold font-poppins line-clamp-2 text-white">
              {tour.tourname}
            </h5>
          </div>
          ...
          <div className="pt-2 flex justify-between items-center font-poppins">
            <p className="text-sm text-gray-400">
              <span className="font-semibold text-[12px] text-green-400">PKR {tour.fee} / person</span>
            </p>
