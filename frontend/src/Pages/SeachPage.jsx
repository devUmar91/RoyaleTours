...
import Card from "../Components/Extra/Card"
  ...
  const SeachPage = () => {
    ...
    const fetchListing = async () => {
      setloading(true)
      try {
        const response = await axios.get(`http://localhost:4000/api/tour/search?${searchQuery}`);
...
// import axios from "axios";
// import Card from "../Components/Extra/Card";
// import BookingComponent from '../Components/Forms/userform'; // Adjust path if necessary
...
//     return (
//         <div className="mt-20 flex flex-col md:flex-row font-medium">
//             <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen md:w-1/3">
//                 <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
//                     {/* ... Search form fields ... */}
//                     <button type='button' className='bg-slate-700 hover:opacity-95 text-white p-3 rounded-lg' onClick={() => setShowModal(true)}>
//                         Proceed Booking
//                     </button>
//                 </form>
//             </div>
...
//             <div className="text-3xl font-semibold border-b-1 p-3 mt-5 flex-1 min-h-screen flex flex-col">
//                 <h1 className='font-poppins text-3xl text-center border-y-2 tracking-[1rem]'> TOURS </h1>
//                 {loading && <h1 className='font-semibold text-3xl text-center mt-10 font-poppins'> Loading ....</h1>}
//                 {data.length === 0 && !loading && <h1 className='font-semibold text-3xl text-center w-full mt-10 font-poppins'>No Results Found</h1>}
...
//             {/* Modal for Booking */}
//             {showModal && (
//                 <BookingComponent setShowModal={setShowModal} />
//             )}
//         </div>
//     );
// };
